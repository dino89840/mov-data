// ============================================
// /functions/update.js
// Save ပြီးတဲ့အခါ Edge Cache ကို သေချာ purge လုပ်
// ============================================
...
export async function onRequestPost(context) {
    ...
    try {
        ...
        // ============================================
        // PASSWORD VALIDATION + Brute Force Protection
        // ============================================
        ...
        if (Array.isArray(parsedData)) {
            ...
            context.waitUntil(
                env.MOVIE_DB.put(`${body.genre}-show`, showData)
            );
        }
        ...
        // ============================================
        // EDGE CACHE PURGE — သေချာ purge လုပ်မှ APK က fresh data ရမည်
        // Cache max-age=3600 ဆိုသောကြောင့် purge မလုပ်ရင် 1 နာရီကြာမည်
        // ============================================
        ...
        context.waitUntil(
            Promise.all(purgeUrls.map(u => cache.delete(new Request(u))))
        );
